...
cdef extern from "flint_wrap.h":
    void fq_zech_ctx_init_ui(fq_zech_ctx_t ctx, ulong p, slong d, const char * var) noexcept
    int _fq_zech_ctx_init_conway_ui(fq_zech_ctx_t ctx, ulong p, slong d, const char * var) noexcept
    void fq_zech_ctx_init_conway_ui(fq_zech_ctx_t ctx, ulong p, slong d, const char * var) noexcept
    void fq_zech_ctx_init_random_ui(fq_zech_ctx_t ctx, ulong p, slong d, const char * var) noexcept
    ...
    void fq_zech_ctx_init_randtest(fq_zech_ctx_t ctx, flint_rand_t state, int type) noexcept
    void fq_zech_ctx_init_randtest_reducible(fq_zech_ctx_t ctx, flint_rand_t state, int type) noexcept
    ...
    ulong fq_zech_ctx_prime(const fq_zech_ctx_t ctx) noexcept
    void fq_zech_ctx_order(fmpz_t f, const fq_zech_ctx_t ctx) noexcept
    ulong fq_zech_ctx_order_ui(const fq_zech_ctx_t ctx) noexcept
    ...
    void _fq_zech_sparse_reduce(nn_ptr R, slong lenR, const fq_zech_ctx_t ctx) noexcept
    void _fq_zech_dense_reduce(nn_ptr R, slong lenR, const fq_zech_ctx_t ctx) noexcept
    void _fq_zech_reduce(nn_ptr r, slong lenR, const fq_zech_ctx_t ctx) noexcept
    ...
    void _fq_zech_inv(nn_ptr * rop, nn_srcptr * op, slong len, const fq_zech_ctx_t ctx) noexcept

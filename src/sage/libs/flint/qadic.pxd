...
cdef extern from "flint_wrap.h":
    ...
    void qadic_ctx_init_modulus(qadic_ctx_t ctx, const fmpz_t p, const fmpz_mod_poly_t modulus, slong min, slong max, const char *var, padic_print_mode mode) noexcept
    void qadic_ctx_init_modulus_nmod(qadic_ctx_t ctx, ulong p, const nmod_poly_t modulus, slong min, slong max, const char *var, padic_print_mode mode) noexcept
    ...
    struct qadic2_sqrt_precomp *_qadic_char2_sqrt_precomp_init(const qadic_ctx_t ctx) noexcept
    int _qadic_char2_sqrt_with_precomp(qadic_t rop, const qadic_t op, const qadic_ctx_t ctx, const struct qadic2_sqrt_precomp *data) noexcept
    void _qadic_char2_sqrt_precomp_clear(struct qadic2_sqrt_precomp *data) noexcept

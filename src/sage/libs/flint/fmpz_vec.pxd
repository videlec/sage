...
cdef extern from "flint_wrap.h":
    ...
    slong _fmpz_vec_max_limbs(const fmpz * vec, slong len) noexcept
    ...
    void _fmpz_vec_get_nmod_vec(nn_ptr res, const fmpz * poly, slong len, nmod_t mod) noexcept
    void _fmpz_vec_set_nmod_vec(fmpz * res, nn_srcptr poly, slong len, nmod_t mod) noexcept
    void _fmpz_vec_get_fft(ulong ** coeffs_f, const fmpz * coeffs_m, slong l, slong length) noexcept
    void _fmpz_vec_set_fft(fmpz * coeffs_m, slong length, const nn_ptr * coeffs_f, slong limbs, slong sign) noexcept
    ...
    void _fmpz_ui_vec_prod(fmpz_t res, nn_srcptr vec, slong len) noexcept
    ...
    void _fmpz_vec_dot_general_naive(fmpz_t res, const fmpz_t initial, int subtract, const fmpz * a, const fmpz * b, int reverse, slong len) noexcept
    void _fmpz_vec_dot_general(fmpz_t res, const fmpz_t initial, int subtract, const fmpz * a, const fmpz * b, int reverse, slong len) noexcept

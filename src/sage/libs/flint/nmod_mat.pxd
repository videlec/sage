...
cdef extern from "flint_wrap.h":
    void nmod_mat_init(nmod_mat_t mat, slong rows, slong cols, ulong n) noexcept
    ...
    nmod_t nmod_mat_mod(const nmod_mat_t mat) noexcept
    void nmod_mat_set_mod(nmod_mat_t mat, ulong n) noexcept
    ulong nmod_mat_get_entry(const nmod_mat_t mat, slong i, slong j) noexcept
    ulong * nmod_mat_entry_ptr(const nmod_mat_t mat, slong i, slong j) noexcept
    void nmod_mat_set_entry(nmod_mat_t mat, slong i, slong j, ulong x) noexcept
    ...
    void nmod_mat_rand(nmod_mat_t mat, flint_rand_t state) noexcept
    int nmod_mat_randpermdiag(nmod_mat_t mat, flint_rand_t state, nn_srcptr diag, slong n) noexcept
    void nmod_mat_randrank(nmod_mat_t mat, flint_rand_t state, slong rank) noexcept
    void nmod_mat_randops(nmod_mat_t mat, flint_rand_t state, slong count) noexcept
    ...
    void nmod_mat_neg(nmod_mat_t B, const nmod_mat_t A) noexcept
    void nmod_mat_scalar_mul(nmod_mat_t B, const nmod_mat_t A, ulong c) noexcept
    void nmod_mat_scalar_addmul_ui(nmod_mat_t C, const nmod_mat_t A, const nmod_mat_t B, const ulong c) noexcept
    void nmod_mat_scalar_mul_fmpz(nmod_mat_t B, const nmod_mat_t A, const fmpz_t c) noexcept
    ...
    void nmod_mat_mul_nmod_vec(ulong * c, const nmod_mat_t A, const ulong * b, slong blen) noexcept
    void nmod_mat_mul_nmod_vec_ptr(ulong * const * c, const nmod_mat_t A, const ulong * const * b, slong blen) noexcept
    void nmod_mat_nmod_vec_mul(ulong * c, const ulong * a, slong alen, const nmod_mat_t B) noexcept
    void nmod_mat_nmod_vec_mul_ptr(ulong * const * c, const ulong * const * a, slong alen, const nmod_mat_t B) noexcept
    ...
    ulong nmod_mat_trace(const nmod_mat_t mat) noexcept
    ulong nmod_mat_det_howell(const nmod_mat_t A) noexcept
    ulong nmod_mat_det(const nmod_mat_t A) noexcept
    ...
    int nmod_mat_solve_vec(nn_ptr x, const nmod_mat_t A, nn_srcptr b) noexcept
    ...
    slong nmod_mat_left_nullspace(nmod_mat_t X, const nmod_mat_t A) noexcept

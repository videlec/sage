...
cdef extern from "flint_wrap.h":
    ...
    void acb_hypgeom_bessel_j_deriv_bound(mag_t res, const acb_t nu, const acb_t z, ulong d) noexcept
    ...
    void acb_hypgeom_dilog_bernoulli(acb_t res, const acb_t z, slong prec) noexcept

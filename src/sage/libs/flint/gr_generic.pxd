...
cdef extern from "flint_wrap.h":
    ...
    void gr_generic_ctx_clear(gr_ctx_t ctx) noexcept
    ...
    int gr_generic_set_str_expr(gr_ptr res, const char * s, int flags, gr_ctx_t ctx) noexcept
    int gr_generic_set_str(gr_ptr res, const char * s, gr_ctx_t ctx) noexcept
    int gr_generic_set_str_balance_additions(gr_ptr res, const char * s, gr_ctx_t ctx) noexcept
    int gr_generic_set_str_ring_exponents(gr_ptr res, const char * s, gr_ctx_t ctx) noexcept
    ...
    int gr_fmpz_mpoly_evaluate_iter(gr_ptr res, const fmpz_mpoly_t f, gr_srcptr x, const fmpz_mpoly_ctx_t mctx, gr_ctx_t ctx) noexcept
    int gr_fmpz_mpoly_evaluate_horner(gr_ptr res, const fmpz_mpoly_t f, gr_srcptr x, const fmpz_mpoly_ctx_t mctx, gr_ctx_t ctx) noexcept
    ...
    int gr_generic_poly_factor_roots( gr_ptr c, gr_vec_t fac, gr_vec_t mult, gr_srcptr elt, int flags, gr_ctx_t ctx) noexcept

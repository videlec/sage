...
cdef extern from "flint_wrap.h":
    void nmod_poly_mat_init(nmod_poly_mat_t mat, slong rows, slong cols, ulong n) noexcept
    ...
    ulong nmod_poly_mat_modulus(const nmod_poly_mat_t mat) noexcept
    ...
    void nmod_poly_mat_window_init(nmod_poly_mat_t window, const nmod_poly_mat_t mat, slong r1, slong c1, slong r2, slong c2) noexcept
    void nmod_poly_mat_window_clear(nmod_poly_mat_t window) noexcept
    void nmod_poly_mat_concat_vertical(nmod_poly_mat_t res, const nmod_poly_mat_t mat1, const nmod_poly_mat_t mat2) noexcept
    void nmod_poly_mat_concat_horizontal(nmod_poly_mat_t res, const nmod_poly_mat_t mat1, const nmod_poly_mat_t mat2) noexcept
    ...
    void nmod_poly_mat_transpose(nmod_poly_mat_t B, const nmod_poly_mat_t A) noexcept
    ...
    void nmod_poly_mat_evaluate_nmod(nmod_mat_t B, const nmod_poly_mat_t A, ulong x) noexcept
    void nmod_poly_mat_scalar_mul_nmod_poly(nmod_poly_mat_t B, const nmod_poly_mat_t A, const nmod_poly_t c) noexcept
    void nmod_poly_mat_scalar_mul_nmod(nmod_poly_mat_t B, const nmod_poly_mat_t A, ulong c) noexcept

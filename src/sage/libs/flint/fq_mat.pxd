...
cdef extern from "flint_wrap.h":
    ...
    void fq_mat_randops(fq_mat_t mat, flint_rand_t state, slong count, const fq_ctx_t ctx) noexcept
    ...
    void fq_mat_transpose(fq_mat_t B, const fq_mat_t A, const fq_ctx_t ctx) noexcept
    ...
    slong fq_mat_rref(fq_mat_t B, const fq_mat_t A, const fq_ctx_t ctx) noexcept

...
cdef extern from "flint_wrap.h":
    ...
    bint _nmod_poly_is_squarefree(nn_srcptr f, slong len, nmod_t mod) noexcept
    ...
    ulong nmod_poly_factor_with_berlekamp(nmod_poly_factor_t res, const nmod_poly_t f) noexcept
    ulong nmod_poly_factor_with_cantor_zassenhaus(nmod_poly_factor_t res, const nmod_poly_t f) noexcept
    ulong nmod_poly_factor_with_kaltofen_shoup(nmod_poly_factor_t res, const nmod_poly_t f) noexcept
    ulong nmod_poly_factor(nmod_poly_factor_t res, const nmod_poly_t f) noexcept

...
cdef extern from "flint_wrap.h":
    void gr_ctx_uninitialized(gr_ctx_t ctx) noexcept
    truth_t truth_and(truth_t x, truth_t y) noexcept
    truth_t truth_or(truth_t x, truth_t y) noexcept
    truth_t truth_not(truth_t x) noexcept
    void truth_println(truth_t x) noexcept
    truth_t gr_in_domain(int status) noexcept
    int gr_check(truth_t t) noexcept
    slong gr_ctx_sizeof_elem(gr_ctx_t ctx) noexcept
    void gr_ctx_clear(gr_ctx_t ctx) noexcept
    ...
    int gr_ctx_ngens(slong * ngens, gr_ctx_t ctx) noexcept
    int gr_ctx_gen_name(char ** name, slong i, gr_ctx_t ctx) noexcept
    gr_ptr gr_ctx_base(gr_ctx_t ctx) noexcept
    ...
    int gr_randtest_invertible(gr_ptr res, flint_rand_t state, gr_ctx_t ctx) noexcept
    ...
    int gr_set_fmpz_2exp_fmpz(gr_ptr res, const fmpz_t a, const fmpz_t b, gr_ctx_t ctx) noexcept
    int gr_get_fmpz_2exp_fmpz(fmpz_t res1, fmpz_t res2, gr_srcptr x, gr_ctx_t ctx) noexcept
    int gr_get_d_2exp_si(double * res, slong * exp, gr_srcptr x, gr_ctx_t ctx) noexcept
    int gr_set_fmpz_10exp_fmpz(gr_ptr res, const fmpz_t a, const fmpz_t b, gr_ctx_t ctx) noexcept
    ...
    int gr_gens_recursive(gr_vec_t res, gr_ctx_t ctx) noexcept
    ...
    int gr_derivative_gen(gr_ptr res, gr_srcptr x, slong var, gr_ctx_t ctx) noexcept
    ...
    int gr_canonical_associate(gr_ptr res, gr_ptr u, gr_srcptr x, gr_ctx_t ctx) noexcept
    ...
    truth_t gr_le(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_lt(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_ge(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_gt(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_abs_le(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_abs_lt(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_abs_ge(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    truth_t gr_abs_gt(gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    int gr_min(gr_ptr res, gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    int gr_max(gr_ptr res, gr_srcptr x, gr_srcptr y, gr_ctx_t ctx) noexcept
    int gr_set_interval_mid_rad(gr_ptr res, gr_srcptr m, gr_srcptr r, gr_ctx_t ctx) noexcept

...
cdef extern from "flint_wrap.h":
    ulong qsieve_knuth_schroeppel(qs_t qs_inf) noexcept
    ulong qsieve_primes_init(qs_t qs_inf) noexcept
    ulong qsieve_primes_increment(qs_t qs_inf, ulong delta) noexcept
    ...
    void qsieve_write_to_file(qs_t qs_inf, ulong prime, const fmpz_t Y, const qs_poly_t poly) noexcept
    hash_t * qsieve_get_table_entry(qs_t qs_inf, ulong prime) noexcept
    void qsieve_add_to_hashtable(qs_t qs_inf, ulong prime) noexcept
    relation_t qsieve_parse_relation(qs_t qs_inf) noexcept

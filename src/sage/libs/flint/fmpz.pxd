...
cdef extern from "flint_wrap.h":
    fmpz PTR_TO_COEFF(mpz_ptr ptr) noexcept
    mpz_ptr COEFF_TO_PTR(fmpz f) noexcept
    mpz_ptr _fmpz_new_mpz() noexcept
    void _fmpz_clear_mpz(fmpz f) noexcept
    void _fmpz_cleanup_mpz_content() noexcept
    void _fmpz_cleanup() noexcept
    mpz_ptr _fmpz_promote(fmpz_t f) noexcept
    mpz_ptr _fmpz_promote_val(fmpz_t f) noexcept
    ...
    void fmpz_randbits_unsigned(fmpz_t f, flint_rand_t state, flint_bitcnt_t bits) noexcept
    ...
    void fmpz_get_uiui(ulong * hi, ulong * low, const fmpz_t f) noexcept
    ulong fmpz_get_nmod(const fmpz_t f, nmod_t mod) noexcept
    ...
    int fmpz_get_mpn(nn_ptr * n, fmpz_t n_in) noexcept
    ...
    void fmpz_set_uiui(fmpz_t f, ulong hi, ulong lo) noexcept
    void fmpz_neg_uiui(fmpz_t f, ulong hi, ulong lo) noexcept
    ...
    void fmpz_set_mpn_large(fmpz_t z, nn_srcptr src, slong n, int negative) noexcept
    ...
    void fmpz_set_ui_smod(fmpz_t f, ulong x, ulong m) noexcept
    ...
    int fmpz_fprint(FILE * fs, const fmpz_t x) noexcept
    ...
    slong fmpz_size(const fmpz_t f) noexcept
    ...
    ulong fmpz_abs_lbound_ui_2exp(slong * exp, const fmpz_t x, int bits) noexcept
    ulong fmpz_abs_ubound_ui_2exp(slong * exp, const fmpz_t x, int bits) noexcept
    ...
    int fmpz_divides(fmpz_t q, const fmpz_t f, const fmpz_t g) noexcept
    ...
    int fmpz_bit_pack(ulong * arr, flint_bitcnt_t shift, flint_bitcnt_t bits, const fmpz_t coeff, int negate, int borrow) noexcept
    int fmpz_bit_unpack(fmpz_t coeff, ulong * arr, flint_bitcnt_t shift, flint_bitcnt_t bits, int negate, int borrow) noexcept
    void fmpz_bit_unpack_unsigned(fmpz_t coeff, const ulong * arr, flint_bitcnt_t shift, flint_bitcnt_t bits) noexcept
    ...
    void fmpz_multi_mod_ui(ulong * out, const fmpz_t input, const fmpz_comb_t comb, fmpz_comb_temp_t temp) noexcept
    void fmpz_multi_CRT_ui(fmpz_t output, nn_srcptr residues, const fmpz_comb_t comb, fmpz_comb_temp_t ctemp, int sign) noexcept
    void fmpz_comb_init(fmpz_comb_t comb, nn_srcptr primes, slong num_primes) noexcept
    ...
    bint fmpz_is_prime_pocklington(fmpz_t F, fmpz_t R, const fmpz_t n, nn_ptr pm1, slong num_pm1) noexcept
    void _fmpz_nm1_trial_factors(const fmpz_t n, nn_ptr pm1, slong * num_pm1, ulong limit) noexcept
    bint fmpz_is_prime_morrison(fmpz_t F, fmpz_t R, const fmpz_t n, nn_ptr pp1, slong num_pp1) noexcept
    void _fmpz_np1_trial_factors(const fmpz_t n, nn_ptr pp1, slong * num_pp1, ulong limit) noexcept

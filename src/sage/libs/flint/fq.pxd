...
cdef extern from "flint_wrap.h":
    ...
    void fq_ctx_init_randtest(fq_ctx_t ctx, flint_rand_t state, int type) noexcept
    void fq_ctx_init_randtest_reducible(fq_ctx_t ctx, flint_rand_t state, int type) noexcept

...
cdef extern from "flint_wrap.h":
    ...
    void _acb_poly_mulmid_transpose(acb_ptr z, acb_srcptr x, slong xlen, acb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec) noexcept
    void acb_poly_mulmid_transpose(acb_poly_t res, const acb_poly_t poly1, const acb_poly_t poly2, slong nlo, slong nhi, slong prec) noexcept
    void _acb_poly_mulmid_classical(acb_ptr z, acb_srcptr x, slong xlen, acb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec) noexcept
    void acb_poly_mulmid_classical(acb_poly_t res, const acb_poly_t poly1, const acb_poly_t poly2, slong nlo, slong nhi, slong prec) noexcept
    void _acb_poly_mulmid(acb_ptr z, acb_srcptr x, slong xlen, acb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec) noexcept
    void acb_poly_mulmid(acb_poly_t res, const acb_poly_t poly1, const acb_poly_t poly2, slong nlo, slong nhi, slong prec) noexcept
    ...
    void _acb_poly_sinc_pi_series(acb_ptr s, acb_srcptr h, slong hlen, slong n, slong prec) noexcept
    void acb_poly_sinc_pi_series(acb_poly_t s, const acb_poly_t h, slong n, slong prec) noexcept
    ...
    double _acb_poly_find_roots_double(acb_ptr roots, acb_srcptr poly, acb_srcptr initial, slong len, slong maxiter, slong prec) noexcept
    double cd_poly_find_roots(double * roots, const double * poly, const double * initial, slong len, slong maxiter, double reltol) noexcept
    double cd_poly_refine_roots(double * z, const double * poly, slong len, double stepsize_bound) noexcept
    double cd_poly_refine_roots_with_pivot(double * z, const double * poly, slong len, double stepsize_bound) noexcept

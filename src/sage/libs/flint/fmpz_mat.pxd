...
cdef extern from "flint_wrap.h":
    ...
    void fmpz_mat_mul_waksman(fmpz_mat_t C, const fmpz_mat_t A, const fmpz_mat_t B) noexcept
    ...
    int fmpz_mat_permanent(fmpz_t res, const fmpz_mat_t A) noexcept
    ...
    void _fmpz_mat_solve_dixon_den(fmpz_mat_t X, fmpz_t den, const fmpz_mat_t A, const fmpz_mat_t B, const nmod_mat_t Ainv, ulong p, const fmpz_t N, const fmpz_t D) noexcept
    ...
    bint fmpz_mat_is_diagonal(const fmpz_mat_t A) noexcept
    void fmpz_mat_snf_transform(fmpz_mat_t S, fmpz_mat_t U, fmpz_mat_t V, const fmpz_mat_t A) noexcept
    slong fmpz_mat_elementary_divisors(fmpz * ed, const fmpz_mat_t A) noexcept
